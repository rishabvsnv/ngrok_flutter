...
class NgrokFlutterBindings {
  ...
  late final _ngrok_start_tunnelPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>('ngrok_start_tunnel');
  late final _ngrok_start_tunnel = _ngrok_start_tunnelPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(
          ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();

  void ngrok_free_string(
  ...
  late final _ngrok_free_stringPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
          'ngrok_free_string');
  late final _ngrok_free_string =
      _ngrok_free_stringPtr.asFunction<void Function(ffi.Pointer<ffi.Char>)>();
}